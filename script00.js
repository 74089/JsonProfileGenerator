...
.then(function(data) {
  ...
  data.forEach(function(element)  {
    ...
    document.getElementById("prettyProfileBoxRow").innerHTML += `<div class="prettyProfileBox"><div class="prettyProfileBoxPic"><img src="${element[elementPicture]}"><div><div class="prettyProfileBoxName"><h1>${element[elementName]}</h1><h2>${element['address']['state']}</h2></div><div class="prettyProfileBoxAbout"><h4>${element[elementAbout]}</h4></div></div>`;
  });
